          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input type="text" class="form-control" value="{{$kostariateam->address .", ". $kostariateam->village->name .", ". $kostariateam->village->district->name .", ". $kostariateam->village->district->regency->name .", ". $kostariateam->village->district->regency->province->name}}" disabled="true">
                </div>
              </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <ol type="1">
                ...
                persoalan-persoalan yang dapat mengganggu <b>PIHAK KEDUA</b> atas pemakaiannya dalam jangka waktu berlakunya surat perjanjian ini.</li>
                <li>Semua kerugian yang timbul akibat kelalaian <b>PIHAK PERTAMA</b> dalam memenuhi kewajibannya tersebut sepenuhnya menjadi tanggung jawab PIHAK PERTAMA.</li>
              </ol>
              <br>
              <br>
              <center><b>Pasal 3 - Pemutusan Kontrak & Serah Terima</b></center>
              <ol type="1">
                <li>Jika <b>PIHAK KEDUA</b> membatalkan kontrak tetapi sudah membayar sebagian atau seluruh biaya sewa, maka uang tersebut menjadi milik PIHAK PERTAMA.</li>
                <li>Apabila <b>PIHAK PERTAMA</b> dan <b>PIHAK KEDUA</b> bermaksud melanjutkan perjanjian kontrak, maka masing-masing pihak harus memberitahukan terlebih dahulu minimal 1 (satu) bulan sebelum jangka waktu kontrak berakhir.</li>
              </ol>
              <br>
              <br>
              ...
              <ol type="1">
                ...
                berdirinya bangunan, seperti: pondasi, balok, kolom, lantai, dan dinding.</li>
                <li><b>PIHAK KEDUA</b> tidak diperbolehkan mengubah struktur dan instalasi dari bangunan tersebut tanpa ijin dan persetujuan dari PIHAK PERTAMA.</li>
                <li><b>PIHAK KEDUA</b> bertanggung jawab atas kerusakan struktur sebagai akibat pemakaian.</li>
                ...
                majeure adalah hal-hal yang disebabkan oleh faktor extern yang tidak dapat diatasi maupun dihindari, seperti: banjir, gempa bumi, tanah longsor, petir, angin topan, kebakaran, huru-hara, kerusuhan, pemberontakan, pencurian dan perang.</li>
              </ol>
              <br>
              <br>
              ...
              <br>
              <ol type="1">
                <li><b>PIHAK KEDUA</b> mendapatkan 7% dari hasil sewa kamar</li>
                <li><b>PIHAK PERTAMA</b> akan mengarahkan para konsumen untuk menggunakan pelayanan kostaria</li>
                <li><b>PIHAK PERTAMA</b> akan memberikan harga yang lebih tinggi pada konsumen yang tidak menggunakan jasa kostaria</li>
              </ol>
              <br>
              <br>
